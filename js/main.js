    ...
    return declare(JBrowsePlugin, {
      constructor: function (args) {
        ...
        var c = new ConfigManager({
          bootConfig: thisB.config2,
          defaults: thisB._configDefaults(),
          browser: thisB
        });
        c.getFinalConfig()
          .then(lang.hitch(thisB, function (finishedConfig2) {
            thisB.config2 = finishedConfig2;

          }));

        browser.afterMilestone('loadRefSeqs', lang.hitch(this, function () {
          ...
          thisB.createNewTrackList(thisB.config2).then(lang.hitch(this, function () {
            ...
            this.browser.config.stores = lang.mixin(this.browser.config.stores, thisB.config2.stores);
            this.browser.config.tracks = lang.mixin(this.browser.config.tracks, thisB.config2.tracks);
            this.browser.trackConfigsByName = lang.mixin(this.browser.trackConfigsByName, thisB.trackConfigsByName);
